...
```
$ cd
$ git clone --single-branch https://github.com/lzl200102109/.tmux.git
...
```
$ git clone --single-branch https://github.com/lzl200102109/.tmux.git "/path/to/oh-my-tmux"
...
[my own Vim configuration]: https://github.com/lzl20010210/.vim.git
